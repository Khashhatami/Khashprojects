...
#' autoTextAnalysis
#'
#'This package accepts txt files, and after cleaning them up 
...
#' @return Word Clouds and negative/positive word ratio
#' @export
textAnalysisFunction<- function(input){
  ...
  inputText <- scan(input, character(0),sep = ".")
  ...
  couldbw<-wordcloud(cloudFrame$word, cloudFrame$freq)
  couldColor<-wordcloud(names(wordCounts), wordCounts, min.freq=2, max.words=50, rot.per=0.35, 
